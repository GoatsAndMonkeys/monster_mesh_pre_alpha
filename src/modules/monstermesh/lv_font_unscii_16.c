 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --no-compress --no-prefilter --bpp 1 --size 16 --font /Users/goatsandmonkeys/Documents/pokemesh/meshtastic-firmware/.pio/libdeps/t-deck-tft/lvgl/scripts/built_in_font/unscii-8.ttf -r 0x20-0x7F --format lvgl -o /tmp/lv_font_unscii_16.c --force-fast-kern-format --lv-font-name lv_font_unscii_16
 ******************************************************************************/
